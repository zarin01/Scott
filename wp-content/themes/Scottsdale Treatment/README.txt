...
* Changed: Removed Simple Social Icons and Genesis eNews Extended plugins from one-click-theme-setup.
* Fixed: CSS list style used for Genesis Blocks pricing table list now set to `none` instead of `disc`.
